import{p as B}from"./chunk-K2ZEYYM2-DkHEM-zN.js";import{p as U}from"./gitGraph-YCYPL57B-RWHQZFFZ-BuiJqfeA.js";import{F as V,p as q,q as X,s as Z,g as j,d as H,c as J,_ as i,l as C,v as K,e as Q,G as Y,a7 as tt,aU as et,aV as z,aW as at,m as rt,aX as it}from"./md-DpKTxjUo.js";import"./chunk-TZBO7MLI-CAiyZF5a.js";import"../monaco/bundled-types-5bawswpH.js";import"../modules/file-saver-igGfcqei.js";import"../modules/vue-DS2shmMQ.js";import"./lz-string-BMV4afKq.js";import"../index-DawE00pv.js";import"../modules/shiki-rtLvZPFg.js";import"./default-CMmxnHsc.js";import"./context-G1rcknZt.js";var F=V.pie,D={sections:new Map,showData:!1,config:F},m=D.sections,w=D.showData,st=structuredClone(F),ot=i(()=>structuredClone(st),"getConfig"),nt=i(()=>{m=new Map,w=D.showData,K()},"clear"),lt=i(({label:t,value:a})=>{m.has(t)||(m.set(t,a),C.debug(`added new section: ${t}, with value: ${a}`))},"addSection"),ct=i(()=>m,"getSections"),pt=i(t=>{w=t},"setShowData"),dt=i(()=>w,"getShowData"),G={getConfig:ot,clear:nt,setDiagramTitle:q,getDiagramTitle:X,setAccTitle:Z,getAccTitle:j,setAccDescription:H,getAccDescription:J,addSection:lt,getSections:ct,setShowData:pt,getShowData:dt},gt=i((t,a)=>{B(t,a),a.setShowData(t.showData),t.sections.map(a.addSection)},"populateDb"),ut={parse:i(async t=>{const a=await U("pie",t);C.debug(a),gt(a,G)},"parse")},ft=i(t=>`
  .pieCircle{
